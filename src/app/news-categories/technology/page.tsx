...
import { technologyArticles } from '@/components/landing/constants';
...
const TechnologyPage: React.FC = () => {
  return (
    <div className="bg-white">
      ...
      <main className="w-full px-6 md:px-12 lg:px-24 xl:px-32 2xl:px-48 py-16"> 
        <h1 className="text-5xl font-bold text-black mb-12">TECHNOLOGY</h1>
          ...
          {technologyArticles.map((article) => (
            ...
            >
              <motion.div
                ...
                className="relative w-full lg:w-[60%] aspect-[3/2] lg:aspect-auto"
              >
                <Image
                  src={article.image}
                  alt={article.title}
              ...
              <div className="w-full lg:w-[65%] p-8 flex flex-col justify-between bg-white">
                <div>
